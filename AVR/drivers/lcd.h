...
#define LCD_BACKLIGHT_PORT  LCD_PORT     /**<port for backlight enable */
#define LCD_DATA0_PIN       0            /**< pin for 4bit data bit 0  */
#define LCD_DATA1_PIN       1            /**< pin for 4bit data bit 1  */
#define LCD_DATA2_PIN       2            /**< pin for 4bit data bit 2  */
#define LCD_DATA3_PIN       3            /**< pin for 4bit data bit 3  */
#define LCD_BACKLIGHT_PIN   7            /**< pin for backlight enable */   
...
/**
 @brief    Turn display backlight on and off
 @param    Non-zero for backlight on, zero for backlight off             
 @return  none
*/
extern void lcd_backlight(uint8_t backlight_on);
