...
Input:   Non-zero for backlight on and zero for backlight off
Returns: none
*************************************************************************/
void lcd_backlight(uint8_t backlight_on)
{
    if(backlight_on){
        LCD_BACKLIGHT_PORT |= _BV(LCD_BACKLIGHT_PIN);
    }
    else {
        LCD_BACKLIGHT_PORT &= ~_BV(LCD_BACKLIGHT_PIN);
    }
...
void lcd_init(uint8_t dispAttr)
{
    ...
    DDR(LCD_BACKLIGHT_PORT) |= _BV(LCD_BACKLIGHT_PIN);
        
    /* set default for backlight as off */
    LCD_BACKLIGHT_PORT &= ~_BV(LCD_BACKLIGHT_PIN);
